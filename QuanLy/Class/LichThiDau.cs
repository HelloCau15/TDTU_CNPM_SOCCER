...
namespace QuanLy.Class
{
    internal class LichThiDau
    {
        ...
        public void ThemLTD(int clb1, int clb2, string date, int svd, int mg)
        {
            string sql = "insert into LichThiDau values ('" + clb1 + "','" + clb2 + "','" + date + "',N'" + svd + "','" + mg + "')";
            kn.hamxuly(sql);
        }
        public void SuaLTD(int malt, int clb1, int clb2, string date, int svd, int mg)
        {
            string sql = "update LichThiDau set IdCLB1='" + clb1 + "',IdCLB2='" + clb2 + "',NgayThiDau='" + date + "',IdSVD='" + svd + "',IdMuaGiai='" + mg + "' where Id='" + malt + "'";
            kn.hamxuly(sql);
        }
